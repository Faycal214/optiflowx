...
- The 0.3.0 release candidate is a pre-release; no stable-API guarantee beyond the frozen contracts is implied until the stable-release decision.

### Release candidate

- Version: `0.3.0rc1`.
- Candidate artifact hashes are generated by the release-candidate CI workflow from the exact candidate commit.
