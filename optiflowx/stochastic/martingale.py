...
The public classes provide the stable library interface while the underlying
implementation lives in :mod:`optiflowx.stochastic.martingale_core`.
"""
...
from .martingale_core import (
    Filtration as _Filtration,
    Martingale as _Martingale,
    StoppedProcess as _StoppedProcess,
    StoppingTime as _StoppingTime,
)
...
class StoppingTime(_StoppingTime):
    ...
    def minimum(self, other):
        """Return ``T wedge S`` as a canonical stopping time."""
        self._same(other)
        return StoppingTime(
            self.space,
    ...
    def maximum(self, other):
        """Return ``T vee S`` as a canonical stopping time."""
        self._same(other)
        return StoppingTime(
            self.space,
    ...
    def add(self, other):
        """Return ``T+S`` as a canonical stopping time."""
        self._same(other)
        values = {}
...
class Martingale(_Martingale):
    ...
    @classmethod
    def doob(cls, terminal, filtration: Filtration):
