...
class PoissonProcess:
    ...
    Examples
    --------
    See the executable examples for `poisson_process.py` and the API reference."""
    ...
    def lambda_(self) -> float:
        ...
        Examples
        --------
        See the executable examples and API reference for `lambda_`."""
        return self.rate
    ...
    def count_probability(self, n: int, t: float) -> float:
        ...
        Examples
        --------
        See the executable examples and API reference for `count_probability`."""
    ...
    def increment_probability(self, n: int, s: float, t: float) -> float:
        ...
        Examples
        --------
        See the executable examples and API reference for `increment_probability`."""
    ...
    def interarrival_samples(
        ...
        Examples
        --------
        See the executable examples and API reference for `interarrival_samples`."""
    ...
    def arrival_times(self, n: int, *, rng: np.random.Generator | None = None) -> np.ndarray:
        ...
        Examples
        --------
        See the executable examples and API reference for `arrival_times`."""
    ...
    def simulate(self, t_max: float, *, rng: np.random.Generator | None = None) -> np.ndarray:
        """Simulate all occurrence times in ``[0, t_max]``.
    ...
    def count_sample(self, t: float, *, rng: np.random.Generator | None = None) -> int:
        ...
        Examples
        --------
        See the executable examples and API reference for `count_sample`."""
        self._validate_time(t)
        generator = rng if rng is not None else np.random.default_rng()
        return int(generator.poisson(self.rate * float(t)))

    def count(self, t: float, *, rng: np.random.Generator | None = None) -> int:
        """Sample ``N(t)`` using the canonical API name ``count``.
        ...
        Examples
        --------
        See the executable examples and API reference for `count`."""
    ...
    def conditional_first_arrival_cdf(self, y: float, s: float) -> float:
        ...
        Examples
        --------
        See the executable examples and API reference for `conditional_first_arrival_cdf`."""
    ...
    def conditional_arrival_times(
        ...
        Examples
        --------
        See the executable examples and API reference for `conditional_arrival_times`."""
    ...
    def superpose(self, other: "PoissonProcess") -> "PoissonProcess":
        ...
        Examples
        --------
        See the executable examples and API reference for `superpose`."""
    ...
    def split(self, probability: float):
        ...
        Examples
        --------
        See the executable examples and API reference for `split`."""
...
class NonHomogeneousPoissonProcess:
    ...
    intensity : Callable[[float], float]
        Callable intensity function.
    mean_function : Callable[[float], float] | None, default None
        Optional callable mean function.
    ...
    def intensity_function(self):
        ...
        Examples
        --------
        See the executable examples and API reference for `intensity_function`."""
        return self.intensity

    def mean(self, t: float) -> float:
        """Return the mean function ``m(t)``.
        ...
        Examples
        --------
        See the executable examples and API reference for `mean`."""
        if not np.isfinite(t) or t < 0:
            raise ValueError("time must be finite and non-negative")
        t = float(t)
...
class _DegeneratePoissonProcess:
    """Internal zero-rate result needed only for splitting endpoints."""
