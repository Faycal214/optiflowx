...
from optiflowx.stochastic.theory import occupation_fraction, occupation_time
...
print("occupation time A =", occupation_time(path, "A", 10.0))
print("occupation fraction A =", occupation_fraction(path, "A", 10.0))
